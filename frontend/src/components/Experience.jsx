    ...
    <section className="mb-20 px-4 w-full max-w-6xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold mb-4 font-mono">
          ...
          <span className="text-gray-200 mx-2">EXPERIENCE</span>
          <span className="text-green-400">]</span>
        </h2>
          ...
          >
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                ...
                <p className="text-green-400 font-mono text-sm mb-2">{exp.company}</p>
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-black/80 border border-green-600/50 rounded-lg shadow-lg p-8 w-11/12 md:w-3/4 lg:w-1/2 font-mono">
            ...
            <ul className="space-y-3 text-gray-300 text-sm">
              {experience[activeMetrics].metrics.map((m, i) => (
                <li key={i}>- {m}</li>
              ))}
            </ul>
