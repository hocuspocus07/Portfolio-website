...
function Footer() {
  return (
    <div className="mt-40 bg-gray-800 pt-12 w-screen">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Grid Layout */}
        <div className="grid grid-cols-1 gap-10 text-center sm:text-left sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <div className="mt-6 flex justify-center sm:justify-start space-x-4">
              <a href="https://in.linkedin.com/in/sajjadhasnain" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-center sm:justify-start space-x-3">
              ...
              <div>
                <a href="mailto:sajjadwork101@gmail.com" className="text-sm font-medium text-white hover:text-gray-300 transition-colors">sajjadwork101@gmail.com</a>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/blogs" className="text-sm text-gray-300 hover:text-white transition-colors">Blogs</a></li>
              <li><a href="/certificates" className="text-sm text-gray-300 hover:text-white transition-colors">Certificates</a></li>
              <li><a href="/projects" className="text-sm text-gray-300 hover:text-white transition-colors">Projects</a></li>
              <li><a href="/contact" className="text-sm text-gray-300 hover:text-white transition-colors">Contact Me</a></li>
            </ul>
          </div>
        </div>
